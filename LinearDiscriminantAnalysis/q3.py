...
err_MyFLDA2_b50 = my_cross_val("MyFLDA2",Boston50_data_perm,Boston50_target_perm,k)

print("MyFLDA2 with Boston75")
err_MyFLDA2_b75 = my_cross_val("MyFLDA2",Boston75_data_perm,Boston75_target_perm,k)
...
print("Logistic Regression with Boston75")
err_MyFLDA2_b75 = my_cross_val("LogisticRegression",Boston75_data_perm,Boston75_target_perm,k)
